...
### Module Installer
1. Download the `tawk-prestashop-9.x-<release_verion>.zip` from [latest release.](https://github.com/tawk/tawk-prestashop/releases)
...
### Manual Installation
1. Download and extract the `tawk-prestashop-9.x-<release_verion>.zip` from [latest release.](https://github.com/tawk/tawk-prestashop/releases)
